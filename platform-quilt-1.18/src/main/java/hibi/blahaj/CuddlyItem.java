	...
	public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
		...
		if(stack.hasNbt()) {
			...
			if(stack.hasCustomName()) {
				tooltip.add(new TranslatableText("tooltip.blahaj.owner.rename", this.getName(), Text.of(owner)).formatted(Formatting.GRAY));
			}
			else {
				tooltip.add(new TranslatableText("tooltip.blahaj.owner.craft", Text.of(owner)).formatted(Formatting.GRAY));
			}
		}
	}
